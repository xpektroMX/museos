...
if (!defined("__CA_DB_DATABASE__")) {
	define("__CA_DB_DATABASE__", 'collective3');
}
...
if (!defined("__CA_APP_DISPLAY_NAME__")) {
	define("__CA_APP_DISPLAY_NAME__", "Secretaria de cultura");
}
...
if (!defined("__CA_ADMIN_EMAIL__")) {
	define("__CA_ADMIN_EMAIL__", 'juanma@notland.mx');
}
...
if (!defined("__CA_BASE_DIR__")) {
	$dir = pathinfo(preg_replace("!/install|/viewers/apps|/tests|support/bin/!", "", 
		isset($_SERVER['SCRIPT_FILENAME']) ? $_SERVER['SCRIPT_FILENAME'] : __FILE__), PATHINFO_DIRNAME);
	$dir = str_replace('lib', 'providence', $dir);
	define("__CA_BASE_DIR__", $dir);
}
// echo $_SERVER['SCRIPT_FILENAME']."<br/>";
// echo __FILE__."<br/>";
// echo PATHINFO_DIRNAME."<br/>";
// echo __CA_BASE_DIR__;
