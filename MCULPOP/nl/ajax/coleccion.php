...
// echo __NOMBRE_COLECCION__;
	...
	for($i=0; $i<$num; $i++){
		...
		<div class="mix colores musico">
			<div class="col3 col s12 m6 l4 xl4">
				<div class="piezaWrap">
					<div class="wrapImg">
						<a href="#" class="trigger" id="<?php echo $ids[$i]; ?>"><img class="img-mcp" src="<?php echo __DIR_WEB__; ?>img/coleccion/thumbs/<?php echo $img[$i]; ?>" style="width:100%;"></a>
					</div>
					<div class="wrapInfo">
						<h5><small><?php echo empty($tit[$i]) ? '&nbsp;' : $tit[$i]; ?></small></h5>
						<h4><?php echo empty($autor[$i]) ? '&nbsp;' : $autor[$i]; ?></h4>
					</div>
				</div>
			</div>                                    
		</div>
