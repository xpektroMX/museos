	...
	for($i=0; $i<$num; $i++){
		...
		<div class="col l4 s12 marco">
			<div class="caja-curaduria">
				<a href="#">
					<div class="imagen trigger" id="<?php echo $ids[$i]; ?>"><img src="<?php echo __DIR_WEB__; ?>img/coleccion/thumbs/<?php echo $img[$i]; ?>" style="max-height:100%; max-width:100%">
					</div>
					<div class="texto">
						<h4><?php echo empty($tit[$i]) ? '&nbsp;' : $tit[$i]; ?></h4>
						<h5><?php echo empty($autor[$i]) ? '&nbsp;' : $autor[$i]; ?></h5>
					</div>
				</a>
