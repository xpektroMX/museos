		...
		<div class="col l4 s12 marco-filtro">
			<div class="padding" >
				<div class="caja-coleccion">
					<div class="imagen trigger" id="<?php echo $ids[$i]; ?>"><img src="<?php echo __DIR_WEB__; ?>img/coleccion/<?php echo $img[$i]; ?>" height='350px'></a></div>
					<h3><?php echo $i."         ";?> <?php echo empty($autor[$i]) ? '&nbsp;' : $autor[$i]; ?></h3>
