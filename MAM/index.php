...
<!-- HEADER 2 !-->
	<div class="seccion-header-secundario">
	<div class="container">
		<div class="caja-header-secundario">
			<div class="imagen" style="background-image: url('img/header-02.jpg');"></div>
			<div class="caja-texto">
				<h2>COLECCIÓN</h2>
				<a href="#">EXPLORAR</a>
				<h3>Arte Mexicano del siglo XX</h3>
				<h3>Vanguardias</h3>
			</div>
			<div class="caja-botones">
				<span class="numero">1</span> / 4<br>
				<button class="boton-atras-coleccion">←</button>
				<button class="boton-adelante-coleccion">→</button>
			</div>
		</div>
	</div>
	</div>
