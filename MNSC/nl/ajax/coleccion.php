	...
	for($i=0; $i<$num; $i++){
		...
		<div class="col l4 s12 marco">
			<div class="caja-temas">
				<a href="#"><div class="imagen trigger" id="<?php echo $ids[$i]; ?>" style="background-image: url('<?php echo __DIR_WEB__; ?>img/coleccion/thumbs/<?php echo $img[$i]; ?>');"></div>
					<h3><?php echo empty($tit[$i]) ? '&nbsp;' : $tit[$i]; ?></h3>
					<h2><?php echo empty($autor[$i]) ? '&nbsp;' : $autor[$i]; ?></h2>
				</a>
			</div>
		</div>
