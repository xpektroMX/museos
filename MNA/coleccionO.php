    ...
    <!-- CONTENIDO COLECCION !-->
        ...
        <div class="container row" >
            ...
            <div class="col l9 s12 derecha">
                ...
                <div class="row row-coleccion">
     
                    <div class="col l4 s12 marco-coleccion">
                    <div class="caja-objeto">
                        <a href="objeto.php"><div class="imagen" style="background-image: url('images/objeto01.jpg');"></div></a>
                        <h3>Tipo de objeto</h3>
                        <h4>Nombre el objeto</h4>
                    </div>
                    </div>
                    <div class="col l4 s12 marco-coleccion">
                    <div class="caja-objeto">
                        <a href="objeto.php"><div class="imagen" style="background-image: url('images/objeto02.jpg');"></div></a>
                        <h3>Tipo de objeto</h3>
                        <h4>Nombre el objeto</h4>
                    </div>
                    </div>
                    <div class="col l4 s12 marco-coleccion">
                    <div class="caja-objeto">
                        <a href="objeto.php"><div class="imagen" style="background-image: url('images/objeto03.jpg');"></div></a>
                        <h3>Tipo de objeto</h3>
                        <h4>Nombre el objeto</h4>
                    </div>
                    </div>
