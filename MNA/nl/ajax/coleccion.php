		...
		<div class="col l4 s12 marco-coleccion">
			<div class="caja-objeto">
				<a href="#"><div class="imagen trigger" id="<?php echo $ids[$i]; ?>" 
					style="background-image: url('<?php echo __DIR_WEB__; ?>img/coleccion/thumbs/<?php echo $img[$i]; ?>');";></div></a>
					<h3 class="mna-coleccion-tipo"><?php echo empty($tipo[$i]) ? '&nbsp;' : $tipo[$i]; ?></h3>
					<h4 class="mna-coleccion-titulo"><?php echo empty($tit[$i]) ? '&nbsp;' : $tit[$i]; ?></h4>
				</div>
			</div>
